...
void Graphics::drawPoint(uint8 color, const CPoint *pt) {
...
void Graphics::drawLine(uint8 color, const CPoint *pt1, const CPoint *pt2) {
...
void Graphics::drawEllipse(uint8 color, bool hasAlpha, const CPoint *pt, int16 rx, int16 ry) {
...
void Graphics::drawSegment(uint8 color, bool hasAlpha, int16 ys, const CPoint *pts, uint8 numPts) {
...
void Graphics::drawPolygonOutline(uint8 color, const CPoint *pts, uint8 numPts) {
...
void Graphics::drawPolygon(uint8 color, bool hasAlpha, const CPoint *pts, uint8 numPts) {
